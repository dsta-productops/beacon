...
Within this Pipeline, the ProductOps and DevSecOps streams divide the work: ProductOps produces the code that implements functional requirements; DevSecOps produces the code that implements non-functional requirements — hardening, integration, reliability. This division follows the [tripartite product structure](/product-roles) — Design owns functional code, Engineering owns NFR code. Both streams are increasingly authored through Claude Code.
